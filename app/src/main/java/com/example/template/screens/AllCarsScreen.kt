...
@Composable
fun AllCarsScreen(navController: NavHostController,paddingValues: PaddingValues) {
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = {
                Text(
                    text = "Enter Police Station Name",
        ...
        Button(modifier = Modifier
            ...
            colors = ButtonDefaults.buttonColors(
                ...
                navController.navigate(Screen.AllCarScreen.route)
            }) {
            Text(
                text = "Search",
                style = MaterialTheme.typography.bodyMedium,
